    ...
    class HostingState : OnlineState
    {
        ...
        public override void OnClientConnected(ulong clientId)
        {
            ...
            else
            {
                ...
                ConnectionManager.instance.NetworkManager.DisconnectClient(clientId, reason);
            }
        ...
        public override void OnUserRequestedShutdown()
        {
            ...
            for (var i = ConnectionManager.instance.NetworkManager.ConnectedClientsIds.Count - 1; i >= 0; i--)
            {
                var id = ConnectionManager.instance.NetworkManager.ConnectedClientsIds[i];
                if (id != ConnectionManager.instance.NetworkManager.LocalClientId)
                {
        ...
        public override void ApprovalCheck(NetworkManager.ConnectionApprovalRequest request, NetworkManager.ConnectionApprovalResponse response)
        {
            ...
            if (LobbyServiceFacade.Instance.CurrentUnityLobby != null)
            {
                LobbyServiceFacade.Instance.RemovePlayerFromLobbyAsync(connectionPayload.playerId);
            }
        }
        ...
        ConnectStatus GetConnectStatus(ConnectionPayload connectionPayload)
        {
            ...
            if (ConnectionManager.instance.GameStarted)
            {
                return ConnectStatus.GameStarted;
            }
