...
namespace CarRacingGame3d
{
    public class CarController : MonoBehaviour
    {
        ...
        void GroundedMovement()
        {
            ...
            if (!brakeInput)
            {
                float targetSpeed = accelerationInput < 0.0f 
                    ? accelerationInput * maxSpeed * 0.5f : nitroInput 
                    ? accelerationInput * maxSpeed * nitroSpeedMultiplier : accelerationInput * maxSpeed;
        ...
        public bool IsNitro()
        {
            return nitroInput && !isRechargeNitro && accelerationInput >= 0.0f && GameManager.instance.GetGameState() != GameStates.countdown;
        }
    }
}