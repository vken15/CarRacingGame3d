...
namespace CarRacingGame3d.UnityServices
{
    public class AuthenticationServiceFacade
    {
        public static AuthenticationServiceFacade Instance => instance ??= new AuthenticationServiceFacade();

        static AuthenticationServiceFacade instance;
        ...
        public InitializationOptions GenerateAuthenticationOptions(string profile)
        {
            ...
            catch (Exception e)
            {
                ...
                ConnectionStatusMessageUIManager.instance.ServiceErrorHandler(new UnityServiceErrorMessage("Authentication Error", reason, UnityServiceErrorMessage.Service.Authentication, e));
                throw;
            }
        }
